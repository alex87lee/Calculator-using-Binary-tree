...
public class Project3 {
	...
	public static void main(String[] args)throws Exception{ 
	    ...
	    if(returnVal == JFileChooser.APPROVE_OPTION) 
	    {
	        ...
	        out.write("in Prefix: " + dummy);  out.newLine();
	        out.write("in InFix: "  + calc.InFix());  out.newLine();
	        out.write("in PostFix: "  + calc.PostFix());  out.newLine();
	        out.write("value: "  + calc.evaluate());  out.newLine();
	        out.newLine();
	            
	        dummy = "";
	        dummy = InToPost(arr[1]);
	        calc = new ExpressionTree(dummy);
	        out.write("in Prefix: " + calc.PreFix());  out.newLine();
	        out.write("in InFix: "  + arr[1]);  out.newLine();
	        out.write("in PostFix: "  + dummy);  out.newLine();
	        out.write("value: "  + calc.evaluate());  out.newLine();
            out.newLine();
        	...
        	calc = new ExpressionTree(dummy);
            out.write("in Prefix: " + calc.PreFix());  out.newLine();
            out.write("in InFix: "  + arr[3]);  out.newLine();
            out.write("in PostFix: "  + calc.PostFix());  out.newLine();
            out.write("value: "  + calc.evaluate());  out.newLine();
            out.newLine();
